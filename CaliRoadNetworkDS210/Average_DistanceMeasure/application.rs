...
pub fn run() -> io::Result<()> {
    ...
    let sample_size = 10; // Sampling this many end nodes for each start node
//here we are using match to return the average distance otherwise it'll throw the None instead of an error. 
